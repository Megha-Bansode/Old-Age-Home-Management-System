...
<div class="main-content">
    <header class="topbar">
        <div class="d-flex align-items-center gap-3">
            ...
            <h1 class="page-title m-0 h4 font-medium text-slate">Create Access Role</h1>
        </div>
    </header>
    
    <div class="content-body container-fluid py-4 px-4">
        <div class="custom-card" style="max-width: 800px; margin: 0 auto;">
            <h2 class="h5 mb-4 text-slate border-bottom pb-3">New Security Role Form</h2>
            
            <form action="#" method="POST" onsubmit="event.preventDefault(); alert('Security role successfully initialized (Mock)');">
                <div class="mb-3">
                    <label class="form-label text-slate font-medium">Role Identifier Name</label>
                    <input type="text" class="form-control rounded-3 p-2.5" placeholder="e.g. Volunteer Assistant" required>
                </div>
                
                <div class="mb-3">
                    <label class="form-label text-slate font-medium">Description</label>
                    <textarea class="form-control rounded-3 p-2.5" rows="3" placeholder="Describe the access limits of this security role..." required></textarea>
                </div>
                ...
                <div class="d-flex justify-content-end gap-3 border-top pt-3">
                    ...
                    <button type="submit" class="btn btn-primary-custom">Create Role</button>
                </div>
            </form>
        </div>
    </div>
