<?php
/**
 * SevaNest – Family Member Dashboard
 * File     : dashboard.php
 * Version  : 1.0
 * Author   : SevaNest Dev Team
 *
 * Description:
 *   Production-ready Family Member Dashboard for the Old-Age Home Management
 *   System. Integrates the existing SevaNest sidebar via PHP include.
 *
 * Sidebar integration:
 *   Set $userRole = 'family_member' before including sidebar.php so the
 *   sidebar renders the correct role-aware navigation.
 */
...
<head>
    ...
    <title>Family Dashboard | SevaNest</title>
...
<!-- ═══════════════════════════════════════════════════════════════════════
     TOP HEADER BAR  (hamburger toggle lives here – see sidebar.css)
     ═══════════════════════════════════════════════════════════════════════ -->
...
<main id="sn-main-content" role="main" aria-label="Family member dashboard content">
    ...
    <div class="dn-page-wrapper">
        ...
        <section class="dn-header-strip dn-animate" aria-labelledby="dn-page-heading">
            ...
            <div class="dn-header-strip__date" aria-live="polite">
                <i class="bi bi-calendar3" aria-hidden="true"></i>
                <time data-dn-live-date><?php echo date('l, d F Y'); ?></time>
            </div>
        </section>
...
<!-- Bootstrap 5 JS bundle (required for tooltips, collapse, etc.) -->
