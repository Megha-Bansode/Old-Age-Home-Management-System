 ...
 *
 * Defines:
 *   - SEVANEST_VERSION : Single constant for the app version number.
 *
 * Outputs:
 *   - Closing </div> for .oahms-main-content opened in header.php.
 *   - Responsive multi-column <footer> with brand, quick links, and contact.
 *   - Footer bottom bar with copyright and version badge.
 *   - Bootstrap JS bundle + header.js clock script.
